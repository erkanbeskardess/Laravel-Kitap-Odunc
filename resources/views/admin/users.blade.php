                        ...
                        <div class="table-responsive">
                            <table class="table no-wrap">
                                ...
                                <tr>
                                    ...
                                    <th class="border-top-0">Rol İşemleri</th>

                                    <th class="border-top-0">Kullanıcı ayarları</th>
                                ...
                                <tr>
                                    ...
                                    <td class="txt-oflo" ><a href="{{route('admin_user_roles',['id'=>$rs->id])}}" target="_blank" >Düzenle</a></td>




                                    <td class="txt-oflo" ><a href="{{route('admin_user_edit',['id'=>$rs->id])}}" target="_blank" >Düzenle</a>
                                    <a href="{{route('admin_user_delete',['id'=>$rs->id])}}" onclick="return confirm('Silmek İstediğinize emin misiniz?')"><p>Delete</p></a></td>
                                </tr>
                                </tbody>
                                @endforeach
                            </table>
