            ...
            <div class="row">
				...
				<span class="contact100-form-title">
                                    ...
                                    <div class="wrap-input100 validate-input" >
                                        <input class="input100" id="name" type="text" name="title" placeholder="Adı">
                                    </div>
                                    <div class="wrap-input100 validate-input" >
                                        <input class="input100" id="name" type="text" name="description" placeholder="Açıklama">
                                    </div>
                                    <div class="wrap-input100 validate-input" >
                                        <input class="input100" id="name" type="text" name="keywords" placeholder="Anahtar kelime">
                                    </div>
                                    <div class="contact100-form-checkbox" >
                                        Statü
                                        <select name="status">
