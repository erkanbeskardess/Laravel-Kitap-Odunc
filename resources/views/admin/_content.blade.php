            ...
            <div class="col-md-12 col-lg-8 col-sm-12">
                <div class="white-box">
                    ...
                    <div class="comment-center">
                        ...
                        <div class="comment-body d-flex">
                            <div class="user-img"> <img src="{{asset('assets')}}/admin/plugins/images/users/sonu.jpg" alt="user"
                                                        class="img-circle">
                            </div>
                            <div class="mail-contnet">
                        ...
                        <div class="comment-body d-flex border-0">
                            <div class="user-img"> <img src="{{asset('assets')}}/admin/plugins/images/users/arijit.jpg" alt="user"
                                                        class="img-circle">
                            </div>
                            <div class="mail-contnet">
