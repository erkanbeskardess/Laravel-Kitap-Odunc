                    ...
                    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1600px;height:560px;overflow:hidden;visibility:hidden;">
                        ...
                        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:560px;overflow:hidden;">
                            <div style="background-color:#d3890e;">
                                <img data-u="image" style="opacity:0.8;" data-src="{{asset('assets')}}/slider/img/pb-beer-1513436-1600.jpg" />
                            ...
                            <div>
                                <img data-u="image" data-src="{{asset('assets')}}/slider/img/px-apartment-chairs-contemporary-2015560-1600.jpg" />
                            ...
                            <div style="background-color:#000000;">
                                <img data-u="image" style="opacity:0.8;" data-src="{{asset('assets')}}/slider/img/px-back-view-boats-couple-2612852-1600.jpg" />
                            ...
                            <div>
                                <img data-u="image" data-src="{{asset('assets')}}/slider/img/yamamoto.jpg" />
                                <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                            ...
                            <div>
                                <img data-u="image" data-src="{{asset('assets')}}/slider/img/wine-1600.jpg" />
                                <div data-ts="flat" data-p="1080" style="left:0px;top:0px;width:1600px;height:560px;position:absolute;">
                                    ...
                                    <img data-to="50% 50%" data-t="15" style="left:780px;top:350px;width:344px;height:157px;position:absolute;opacity:0;max-width:344px;" data-src="{{asset('assets')}}/slider/img/wine-atlantic-ocean.png" />
                                    <img data-to="50% 50%" data-t="16" style="left:1330px;top:8px;width:172px;height:131px;position:absolute;opacity:0;max-width:172px;" data-src="{{asset('assets')}}/slider/img/wine-badge.png" />
                                </div>
                            </div>
