                ...
                <div class="white-box">
                    ...
                    <div class="container-contact100">
                        <div class="wrap-contact100">
                            <form  action="{{route('borrow_update' , ['id'=>$data->id])}}" method="post" enctype="multipart/form-data" class="contact100-form validate-form">
                                @csrf
                                ...
                                <div class="wrap-input100 validate-input" >
                                    <input class="input100" type="text" name="name" value="{{Auth::user()->name}} " readonly="readonly" placeholder="">
                                </div>
                                <label>Kitap idleri:</label>
                                <div class="wrap-input100 validate-input" >
                                    <input class="input100" type="number" name="books_id" value="{{$data->books_id}} " readonly="readonly" placeholder="{{$data->books_id}}" >
                                </div>


                                <label>Tel No.:</label>
                                <div class="wrap-input100 validate-input" >
                                    <input class="input100" type="number" name="phone" value="{{Auth::user()->phone}} " readonly="readonly" placeholder="{{Auth::user()->phone}}" >
                                </div>
                            ...
                            <div  style="margin-top:10px;margin-left:300px;background-color: #5cb85c;font-size:72px; " ><a href="{{route('borrow_delete',['id'=>$data->id])}}" onclick="return confirm('Silmek İstediğinize emin misiniz?')">Talebi Sil</a></div>
